...
export const WINDOWS_DOWNLOAD_URL =
  "https://github.com/tahar1208guelma/cv-builder/releases/latest/download/cv-builder-windows.zip";

export const MACOS_DOWNLOAD_URL =
  "https://github.com/tahar1208guelma/cv-builder/releases/latest/download/cv-builder-macos.zip";

export const ANDROID_DOWNLOAD_URL =
  "https://github.com/tahar1208guelma/cv-builder/releases/latest/download/cv-builder-android.apk";
...
export const PLATFORMS = [
  ...
  },
  {
    ...
    recommended: false,
    highlight: "Mobile & Tablet Optimized",
  },
  {
    id: "macos",
    name: "macOS",
